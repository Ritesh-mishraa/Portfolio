        ...
        >
          <div className="contact-wrapper">
            ...
            <div className="social-icons-footer">
              <a href="https://github.com/Ritesh-mishraa" target="_blank" rel="noopener noreferrer" className="footer-icon" aria-label="GitHub">
                <FaGithub />
              </a>
              <a href="https://www.linkedin.com/in/ritesh-kumar-mishra-a7b8b3249/" target="_blank" rel="noopener noreferrer" className="footer-icon" aria-label="LinkedIn">
                <FaLinkedinIn />
              </a>
            </div>
          </div>
